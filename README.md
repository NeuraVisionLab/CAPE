...
- **`distance_threshold`**: The loss is designed to work with distance maps which are usually thresholded with a value. This parameter indicates the value used to threshold the ground truth.
